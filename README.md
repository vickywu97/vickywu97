...
| [📉 legal-hallucination-bench](https://github.com/vickywu97/legal-hallucination-bench) _(私有仓库 · 需授权访问 · Private — access on request)_ | **量化基准 · Quantification** | 5 国产模型 × 29 陷阱题，HVI **33.3%–54.2%**，8 法域逐字 EXACT 全 0%；ground truth **2,327** 节点含 **212** 个 Tier A 专家逐条签核节点 / 5 models × 29 traps, HVI 33.3–54.2%, 8 laws EXACT all 0%; ground truth 2,327 nodes incl. 212 Tier A attorney-signed. |
...
- **legal-hallucination-bench**（量化基准 · 私有）：5 国产模型 × 29 陷阱题，HVI **33.3%–54.2%**，8 法域逐字 EXACT 全 0%。
